...
```bash
$ git clone https://github.com/thiiagoms/open-closed-principle-php
$ cd open-closed-principle-php
open-closed-principle-php $ docker-compose up -d
open-closed-principle-php $ docker-compose exec app bash
